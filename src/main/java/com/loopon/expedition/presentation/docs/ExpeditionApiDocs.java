...
public interface ExpeditionApiDocs {
    ...
    ResponseEntity<CommonResponse<SliceResponse<ExpeditionSearchResponse>>> searchExpeditions(
            @NotBlank
    ...
    ResponseEntity<CommonResponse<ExpeditionDeleteResponse>> deleteExpedition(
            @Parameter(description = "탐험대 ID") @PathVariable("expeditionId") Long expeditionId,
            @AuthenticationPrincipal PrincipalDetails principalDetails
    );

    @Operation(summary = "탐험대 멤버 조회", description = "특정 탐험대에 속한 멤버 목록을 조회합니다.")
    ResponseEntity<CommonResponse<ExpeditionUsersResponse>> usersExpedition(
            @Parameter(description = "탐험대 ID") @PathVariable("expeditionId") Long expeditionId,
            @AuthenticationPrincipal PrincipalDetails principalDetails
    );

    @Operation(summary = "멤버 추방 (방장 전용)", description = "방장이 특정 멤버를 탐험대에서 내보냅니다.")
    ResponseEntity<CommonResponse<ExpeditionExpelResponse>> expelExpedition(
            @Parameter(description = "탐험대 ID") @PathVariable("expeditionId") Long expeditionId,
    ...
    ResponseEntity<CommonResponse<SliceResponse<ExpeditionChallengesResponse>>> challengesExpedition(
            @Parameter(description = "탐험대 ID") @PathVariable("expeditionId") Long expeditionId,
            @AuthenticationPrincipal PrincipalDetails principalDetails,
            Pageable pageable
    );
    ...
    ResponseEntity<CommonResponse<ExpeditionCancelExpelResponse>> cancelExpelExpedition(
            @Parameter(description = "탐험대 ID") @PathVariable("expeditionId") Long expeditionId,
    ...
    ResponseEntity<CommonResponse<ExpeditionGetResponse>> getExpedition(
            @Parameter(description = "탐험대 ID") @PathVariable("expeditionId") Long expeditionId,
            @AuthenticationPrincipal PrincipalDetails principalDetails
    );

    @Operation(summary = "탐험대 설정 수정", description = "탐험대 설정을 수정합니다.")
    ResponseEntity<CommonResponse<ExpeditionModifyResponse>> modifyExpedition(
            @Parameter(description = "탐험대 ID") @PathVariable("expeditionId") Long expeditionId,
